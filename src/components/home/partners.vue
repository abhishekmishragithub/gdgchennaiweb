    ...
    <!-- <v-container class="pa-0 pb-5"> -->
        <v-layout wrap align-center justify-center row fill-height>
            ...
            <!-- <v-flex xs12 md12 class="mt-3">
                <p class="google-font my-2" style="font-size:110%">Our Sponsors</p>
                            ...
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:5px;border-width: 1px; border-style: solid;">
                                        <a href="https://gdgchennai.com" target="_blank">
                                        <v-tooltip bottom>
                                            <template v-slot:activator="{ on }">
                                        <v-img
                                            :src="require('@/assets/img/partners/gdgchennai.png')"
                                            :lazy-src="require('@/assets/img/partners/gdgchennai.png')"
                                            aspect-ratio="3.0"
                                            class="white"
                                            v-on="on"
                                        >
                                        ...
                                        <span class="google-font">GDG XXX</span>
                                        </v-tooltip>
                                        </a>
                                    </v-card>
                                    </v-flex>
